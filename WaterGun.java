...
public class WaterGun extends Attack
{
     ...
     */
    public WaterGun(BattleOrderActionBlock a, BattleOrderActionBlock b)
    {
        image = new GreenfootImage("AttackSprites/watergun0.png");
        setImage(image);
         
        this.getImage().setTransparency(0);
        this.getImage().scale(450, 120);
        this.a = a;
        this.b = b;
    }
