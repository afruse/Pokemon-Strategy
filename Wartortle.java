 ...
 */
public class Wartortle extends MoveablePokemon
{
    ...
    public Wartortle(int mapIndexX, int mapIndexY, boolean isPlayer, int lvl, int curXp, int xpNeeded){
        super(mapIndexX,mapIndexY, isPlayer, lvl, curXp, xpNeeded);
        cAttackString = "Bite";
        vAttackString = "Water Gun";
        image = new GreenfootImage("images/Pokemon/wartortle.png");
        animationImage = new GreenfootImage("images/Pokemon/wartortle.png");
