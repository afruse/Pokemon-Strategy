 ...
 */
public class Zapdos extends MoveablePokemon
{
    ...
    public Zapdos(int mapIndexX, int mapIndexY, boolean isPlayer, int lvl, int curXp, int xpNeeded){
        super(mapIndexX,mapIndexY, isPlayer, lvl, curXp, xpNeeded);
        cAttackString = "Thunder Shock";
        vAttackString = "Wing Attack";
        image = new GreenfootImage("images/Pokemon/zapdos.png");
        animationImage = new GreenfootImage("images/Pokemon/zapdos.png");
